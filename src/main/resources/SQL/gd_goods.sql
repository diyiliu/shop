...
CREATE TABLE `gd_goods` (
  ...
  `SERIAL` varbinary(50) DEFAULT NULL COMMENT '序列号',
  `NAME` varbinary(120) DEFAULT NULL COMMENT '名称',
  `STORE` varbinary(100) DEFAULT NULL COMMENT '店名',
  `STORE_TYPE` varbinary(10) DEFAULT NULL COMMENT '店家类型',
  `IMAGE_PATH` varbinary(200) DEFAULT NULL COMMENT '图片地址',
  ...
  `LINK1` varbinary(200) DEFAULT NULL COMMENT '链接1',
